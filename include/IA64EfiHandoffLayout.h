...
struct EfiHandoffLayout {
    ...
    uint64_t simpleTextInputProtocolAddr = 0;
    uint64_t simpleTextInputExProtocolAddr = 0;
    uint64_t consoleInputEventAddr = 0;
    uint64_t inputResetStubCodeAddr = 0;
    uint64_t inputResetStubDescAddr = 0;
    uint64_t inputReadKeyStrokeStubCodeAddr = 0;
    uint64_t inputReadKeyStrokeStubDescAddr = 0;
    uint64_t inputReadKeyStrokeExStubCodeAddr = 0;
    uint64_t inputReadKeyStrokeExStubDescAddr = 0;
    uint64_t inputRegisterKeyNotifyStubCodeAddr = 0;
    uint64_t inputRegisterKeyNotifyStubDescAddr = 0;
    uint64_t inputUnregisterKeyNotifyStubCodeAddr = 0;
    uint64_t inputUnregisterKeyNotifyStubDescAddr = 0;
    uint64_t waitForEventStubCodeAddr = 0;
    uint64_t waitForEventStubDescAddr = 0;
    uint64_t checkEventStubCodeAddr = 0;
    uint64_t checkEventStubDescAddr = 0;
...
constexpr uint64_t kEfiSimpleTextInputProtocolOffset = 0x1A80ULL;
constexpr uint64_t kEfiSimpleTextInputExProtocolOffset = 0x1AA0ULL;
constexpr uint64_t kEfiConsoleInputEventOffset = 0x1AE0ULL;
constexpr uint64_t kEfiInputResetStubCodeOffset = 0x1B00ULL;
constexpr uint64_t kEfiInputResetStubDescOffset = 0x1B40ULL;
constexpr uint64_t kEfiInputReadKeyStrokeStubCodeOffset = 0x1B80ULL;
constexpr uint64_t kEfiInputReadKeyStrokeStubDescOffset = 0x1BC0ULL;
constexpr uint64_t kEfiInputReadKeyStrokeExStubCodeOffset = 0x1C00ULL;
constexpr uint64_t kEfiInputReadKeyStrokeExStubDescOffset = 0x1C40ULL;
constexpr uint64_t kEfiInputRegisterKeyNotifyStubCodeOffset = 0x1C80ULL;
constexpr uint64_t kEfiInputRegisterKeyNotifyStubDescOffset = 0x1CC0ULL;
constexpr uint64_t kEfiInputUnregisterKeyNotifyStubCodeOffset = 0x1CA0ULL;
constexpr uint64_t kEfiInputUnregisterKeyNotifyStubDescOffset = 0x1CE0ULL;
constexpr uint64_t kEfiWaitForEventStubCodeOffset = 0x1D40ULL;
constexpr uint64_t kEfiWaitForEventStubDescOffset = 0x1D80ULL;
constexpr uint64_t kEfiCheckEventStubCodeOffset = 0x1DC0ULL;
constexpr uint64_t kEfiCheckEventStubDescOffset = 0x1E00ULL;
...
inline bool tryComputeEfiHandoffLayout(uint64_t guestMemorySize, EfiHandoffLayout& layout) {
    ...
    layout.simpleTextInputProtocolAddr = base + kEfiSimpleTextInputProtocolOffset;
    layout.simpleTextInputExProtocolAddr = base + kEfiSimpleTextInputExProtocolOffset;
    layout.consoleInputEventAddr = base + kEfiConsoleInputEventOffset;
    layout.inputResetStubCodeAddr = base + kEfiInputResetStubCodeOffset;
    layout.inputResetStubDescAddr = base + kEfiInputResetStubDescOffset;
    layout.inputReadKeyStrokeStubCodeAddr = base + kEfiInputReadKeyStrokeStubCodeOffset;
    layout.inputReadKeyStrokeStubDescAddr = base + kEfiInputReadKeyStrokeStubDescOffset;
    layout.inputReadKeyStrokeExStubCodeAddr = base + kEfiInputReadKeyStrokeExStubCodeOffset;
    layout.inputReadKeyStrokeExStubDescAddr = base + kEfiInputReadKeyStrokeExStubDescOffset;
    layout.inputRegisterKeyNotifyStubCodeAddr = base + kEfiInputRegisterKeyNotifyStubCodeOffset;
    layout.inputRegisterKeyNotifyStubDescAddr = base + kEfiInputRegisterKeyNotifyStubDescOffset;
    layout.inputUnregisterKeyNotifyStubCodeAddr = base + kEfiInputUnregisterKeyNotifyStubCodeOffset;
    layout.inputUnregisterKeyNotifyStubDescAddr = base + kEfiInputUnregisterKeyNotifyStubDescOffset;
    layout.waitForEventStubCodeAddr = base + kEfiWaitForEventStubCodeOffset;
    layout.waitForEventStubDescAddr = base + kEfiWaitForEventStubDescOffset;
    layout.checkEventStubCodeAddr = base + kEfiCheckEventStubCodeOffset;
    layout.checkEventStubDescAddr = base + kEfiCheckEventStubDescOffset;
